...
//General
$APIKey = "B4A4A27801AB83DEA1598A35DDD121D6"; // Go get your API here: http://steamcommunity.com/dev/apikey

$load_name ="StarWarsRP"; // For your Browser Name
$community_name ="The EchoGaming"; // Your community/server name. The one in the middle
$community_url = "http://theechogaming.enjin.com/"; // Url for your users to know where to go
$intro = TRUE; // If you want to turn this off, type FALSE instead
// Introduction
$tagline = " A long time ago, in a planet far,<br> far away...."; // The intro text in the beginning of the animation
// Above Server Name
